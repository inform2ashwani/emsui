...
export default function AddEditEquipName({open,handleClose,data,onChange,handleFormSubmit}) {
 const {id,name,email,phone,dob}=data 
  return (
    <div>
      ...
      >
        <DialogTitle >{id?"Update Equipment Name":"Create Equipment Name"}</DialogTitle>
        <DialogContent>
         <form>
