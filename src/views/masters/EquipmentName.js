...
import AddEditEquipName from './AddEditEquipName';
...
const initialValue = {  
  ...
  function EquipmentName() {
    ...
    const columnDefs = [
      ...
      {headerName: 'Equipment Name',field :"name",width: 150, sortable: true},     
   ...
   const getUsers = async () => {
    await axios.get(url+`/SubMaster?masterid=1`) 
    .then(resp =>{
    // console.log(resp)
  ...
  const defaultColDef = {
   ...
   return (    
      ...
      <AddEditEquipName open={open} handleClose={handleClose}
